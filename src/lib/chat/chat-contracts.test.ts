...
describe.skip("chat action acceptance contracts", () => {
  it("updates the account holder phone number and queues a redacted notification", () => {
    expect.fail("Implement this in your chat action tests.");
  });

  it("adds an authorized related person with name, email, and phone", () => {
    expect.fail("Implement this in your chat action tests.");
  });
